...
**Status snapshot:** P0 done · P1 case core shipped · **this wave: P1 production-ready** (multi-TF features, regime/vol/reds, retrieve) · P2 decide+log only after that exit.
