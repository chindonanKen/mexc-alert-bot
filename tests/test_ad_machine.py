...
class TestMachineIsolationAndApi(unittest.TestCase):
    ...
    def test_flag_on_seeds_six_and_page(self):
        ...
        self.assertIn("invite", page.text)
        self.assertIn("chorus", page.text)
        self.assertIn("The line is the room", page.text)
        ...
        css = c.get("/assets/machine.css?v=m3")
        self.assertEqual(css.status_code, 200)
        self.assertIn("Newsreader", css.text)
        self.assertIn("@keyframes filament", css.text)
        self.assertIn("@keyframes powder", css.text)
